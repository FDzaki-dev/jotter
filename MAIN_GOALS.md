...
| Grid/List toggle | 🔧 | Real device test nemu bug (preferensi gak persist, selalu reset ke Grid tiap app restart, Batch48) — sudah difix, BELUM dikonfirmasi ulang pasca-fix |
